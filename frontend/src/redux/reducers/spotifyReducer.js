...
import {FETCH_CURRENT_SONG, FETCH_NEXT_SONG, FETCH_PREVIOUS_SONG, FETCH_SHUFFLE, FETCH_SAVE_SONG} from "../actions/spotify";
...
export default function (state = default_state, action) {
    switch (action.type) {
        ...
        case FETCH_CURRENT_SONG:
            return {...state, song: action.payload.data.item.name, songId: action.payload.data.item.id};

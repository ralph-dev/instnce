...
class LoadingIcon extends React.Component {
    constructor(props) {
        super(props);
        this.svg = `<svg class="lds-spinner" width="${props.width}" height="${props.height}" xmlns="http://www.w3.org/2000/svg"
    ...
    render() {
        return <div dangerouslySetInnerHTML={{__html: this.svg}} className={"loading-icon-wrapper"}/>
    }
}
